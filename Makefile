...
linux-debug: ${LINUX_DEBUG_BUILD_DIR}
	make -C${LINUX_DEBUG_BUILD_DIR}

linux-release: ${LINUX_RELEASE_BUILD_DIR}
	make -C${LINUX_RELEASE_BUILD_DIR}

windows-package: ${WINDOWS_PACKAGE_DIR}

${LINUX_DEBUG_BUILD_DIR}:
	cmake -B${LINUX_DEBUG_BUILD_DIR} -DCMAKE_BUILD_TYPE=Debug -DCMAKE_EXPORT_COMPILE_COMMANDS=YES
	@cp ${LINUX_DEBUG_BUILD_DIR}/compile_commands.json ${LINUX_BUILD_DIR}/

${LINUX_RELEASE_BUILD_DIR}:
	cmake -B${LINUX_RELEASE_BUILD_DIR} -DCMAKE_BUILD_TYPE=Release
